...
- **Do** style inline links in prose with `.rp-inline` (underline, 4 px offset, one step lighter on
  hover) and chrome links with `.rp-link`; no ad-hoc utility strings on anchors (2026-09-03).
