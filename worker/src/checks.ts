...
export interface CheckDoc {
  ...
  pending_runs: { trigger?: "manual" | "webhook"; run_id: string; claimed_new: number | null; body_note: string | null; queued_at: string; reported_failure?: boolean; reported_error?: string | null }[];
