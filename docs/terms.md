...
Canonical text of https://verifyruns.pages.dev/terms. Last updated 2026-08-29.

What you agree to when you create an account, and what you can expect back.

## Who you are dealing with

VerifyRuns is operated by Farjad Hasan, an individual developer based in Pakistan. By creating an account you agree to these terms and to the privacy policy (`privacy.md`). Contact: farjad.developer@gmail.com.
...
Use VerifyRuns to verify destinations your automations write to. That means:
...
We may suspend or delete accounts that break the rules above or that put the service or other users at risk, and we may set limits on Checks, runs and history per plan. We will not read your destinations for any purpose other than producing your verdicts.
...
Your destinations and their contents stay yours. What we keep, for how long, and how to delete it is set out in the privacy policy and `what-we-store.md`.

## Changes and law

Changes to these terms are dated at the top of this page and material ones are emailed to account holders before they apply. These terms are governed by the laws of Pakistan.
