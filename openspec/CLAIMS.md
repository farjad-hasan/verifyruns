...
|---|---|---|---|---|
| email-alerts-upcoming | Dev | branch `email-alerts-upcoming` | 2026-09-14 | active — split password_reset vs email_alerts; email alert channels upcoming until VR_EMAIL_ALERTS=1 |
