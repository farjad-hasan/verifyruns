...
- [x] 2.3 `docs/self-hosting.md` (all env vars, process model, network caveat, backups), `docs/what-we-store.md` (honest current state), `docs/security.md` (disclosure contact, posture, tracked gaps)
