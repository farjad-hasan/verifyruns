...
- [x] 8.4 Commit in reviewed groups (tokens; verdict channel; worker; detail+dashboard; forms+public; marketing) and push; deploy Worker + Pages together; verified 2026-08-30: Worker version 4d269020, Pages deployment ace9a5d7 (commit 961d089); the dogfood row on verifyruns.pages.dev shows "Destination gained 1 record(s), matching what your workflow reported."; live detector 2 desktop / 1 mobile
